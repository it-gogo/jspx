 ...
 * 轮播管理控制器
 * @author zhangjf
 * @create_time 2016-3-25 下午3:04:17
 */
@Controller
@RequestMapping("/site/carouselManagement")
public class CarouselManagementController extends BaseController {
	  @Resource
	  ...
	  public String redirectOA(){
		  return  "admin/site/carouselManagement/list";
	  }
	  /**
	   * 添加数据页面
	   * @return
	  ...
	  public  String addOA(HttpServletRequest request,HttpServletResponse response,Model  model){
		  return  "admin/site/carouselManagement/edit";
	  } 
	  /**
	   * 导出数据
	   * @param request
	  ...
	  public  String loadOA(HttpServletRequest request, HttpServletResponse response,Model  model){
		  ...
		  Map<String,Object>  res = this.carouselManagementService.load(parameter);
	  ...
	  public  void all(HttpServletRequest request, HttpServletResponse response,Model  model){
		  Map<String,Object>  parameter = sqlUtil.setParameterInfo(request);
		  List<Map<String,Object>>  list = this.carouselManagementService.findAll(parameter);
	  ...
	  public  String load(HttpServletRequest request, HttpServletResponse response,Model  model){
		  ...
		  Map<String,Object>  res = this.carouselManagementService.load(parameter);
		  model.addAttribute("vo", res);
		  return  "admin/wechat/carouselManagement/edit";
	  }
	  /**
	   * 保存
	   * @param request
	 ...
	 * @throws Exception 
	  ...
	  public  void save(HttpServletRequest request, HttpServletResponse response) throws Exception{
		  ...
		  MultipartHttpServletRequest multipartRequest = (MultipartHttpServletRequest) request;  
		   /**得到图片保存目录的真实路径**/      
	        String logoRealPathDir = request.getSession().getServletContext().getRealPath("admin/carouselPic");     
	        /**根据真实路径创建目录**/      
	       ...
	       if(suffix!=null && !"".equals(suffix)){
	    	   ...
	    	   parameter.put("picUrl", "admin/carouselPic/"+fileName);
	       }
		  ...
		  if(isIDNull){
			  ...
			  //添加菜单
			  this.carouselManagementService.add(n_parameter);
			  this.ajaxMessage(response, Syscontants.MESSAGE,"添加成功");
			  
		  }else{
			  this.carouselManagementService.update(parameter);
	  ...
	  public  void  findList(HttpServletRequest request, HttpServletResponse response,Model  model){
		  ...
		  JSONObject jsonObj = this.carouselManagementService.findPageBean(parameter);
	  ...
	  public  void  delete(HttpServletRequest request, HttpServletResponse response){
		  ...
		  this.carouselManagementService.delete(parameter);
	  ...
	  /**
		...
		public void changeStatus(HttpServletRequest request,HttpServletResponse response){
			...
			this.carouselManagementService.changeStatus(parameter);
		}
}
