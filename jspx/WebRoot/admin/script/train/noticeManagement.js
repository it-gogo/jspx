 ...
 * 打开添加数据窗口参数
 */
var options = {id:"d3",title:"站内通知",width:"100%",height:"100%",toolbar:dbuttons};
//添加函数
function  addF(){
	var urls = "../train/noticeManagement/add.do";
	options.urls = urls;
 ...
 */
function  loadF(row){
	var urls = "../train/noticeManagement/load.do?id="+row.id;
	options.urls = urls;
	parent.$.createDialog(options);
	parent.$.createDialog.open_grid = dataGrid;
}
 ...
 */
function  look(row){
	var parameter = {id:"d3",title:"站内通知",width:"100%",height:"100%"};
