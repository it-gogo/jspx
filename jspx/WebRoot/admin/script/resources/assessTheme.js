 ...
 * 打开添加数据窗口参数
 */
var options = {id:"d3",title:"评估主题编辑",width:"900px;",height:"500px;",buttons:dbuttons};
//添加函数
function  addF(){
	var urls = "../resources/assessTheme/add.do";
	options.urls = urls;
 ...
 */
function  loadF(row){
	var urls = "../resources/assessTheme/load.do?id="+row.id;
	options.urls = urls;
	parent.$.createDialog(options);
	parent.$.createDialog.open_grid = dataGrid;
}
