 ...
 * 打开添加数据窗口参数
 */
var options = {id:"d3",title:"文章标题颜色",width:"600px;",height:"400px;",buttons:dbuttons};
//添加函数
function  addF(){
	var urls = "../site/articleTitleColor/add.do";
	options.urls = urls;
 ...
 */
function  loadF(row){
	var urls = "../site/articleTitleColor/load.do?id="+row.id;
	options.urls = urls;
	parent.$.createDialog(options);
	parent.$.createDialog.open_grid = dataGrid;
}
