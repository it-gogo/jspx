...
cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"")+"\" "+(item.iconImg?"style=\"background:url("+uri+item.iconImg+")\"":"")+" ></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon tree-folder tree-folder-open "+(item.iconCls?item.iconCls:"")+"\"  "+(item.iconImg?"style=\"background:url("+uri+item.iconImg+")\"":"")+" ></span>");
}else{
cc.push("<span class=\"tree-indent\"></span>");
cc.push("<span class=\"tree-icon tree-file "+(item.iconCls?item.iconCls:"")+"\"  "+(item.iconImg?"style=\"background:url("+uri+item.iconImg+")\"":"")+"></span>");
_12d=true;
}
}
if(opts.checkbox){
