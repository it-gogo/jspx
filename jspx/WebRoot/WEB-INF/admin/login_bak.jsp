...
<body style="background-color:#1c77ac; background-image:url('/wxjk/css/images/light.png'); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
    <div id="mainBody">
