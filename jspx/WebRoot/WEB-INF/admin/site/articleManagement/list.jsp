			...
			var dataGrid;
		 	$(document).ready(function(){
		 		var type=encodeURI("oa栏目");
			  	var gridoption = {url:"list.do?sectionType="+type+"&authLoginId=${user.id}",id:"grid",pagination:true};
			  	dataGrid = $.initBasicGrid(gridoption); 
			  	
			  	var treeoptions = {id:"treeID",url:"../sectionManagement/tree.do?type="+type+"&authLoginId=${user.id}",onClick:treeClick};
