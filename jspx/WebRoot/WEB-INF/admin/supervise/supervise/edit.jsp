...
function beforeSubmit(){
  ...
  <body >
  	...
  	<form id="dform" method="post" >
		<div data-options="region:'west',split:true,title:'项目库列表',collapsible:true" style="width:200px;">
			<%@include file="/WEB-INF/admin/common/tree.jsp"%>
		</div>
		<div data-options="region:'east',split:true,title:'学校列表',collapsible:true" style="width:300px;">
         ...
         <div data-options="region:'north'"  style="height:100px;">
			...
			<table width="100%" class="table table-hover table-condensed">
				...
				<tr>
					<th  width="100px">手动添加项目</th>
					<td  width="100px">
						<a id="btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'" onclick="addRow();">添加项目</a>
					</td>
				</tr>
			</table>
     	...
     	<table id="mxList" class="easyui-datagrid"  data-options="border:false,autoRowHeight:true,border:false,
		    ...
		    <thead>   
		        <tr>   
		            ...
		            <th data-options="field:'projectName'"  formatter="showName"  width="10">项目名称</th>   
		            <th data-options="field:'remark'" formatter="showRemark"   width="30">项目说明</th>
		            <th data-options="field:'handle'" formatter="handlerstr" width="5">操作</th>
		        </tr>   
		    </thead>   
		    <tbody>   
		    </tbody>   
