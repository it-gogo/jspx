...
<html>
  <head>
	...
	$(document).ready(function(){
		var  formOptions = {id:"dform",urls:"saveUnit.do"};
         ...
         <form id="dform" method="post" >
			...
			<table width="100%" class="table table-hover table-condensed">
				...
				<tr>
			        <th>上级单位</th>
					<td>
						<input class="easyui-combotree" style="width:350px;"  name="pid" value="${vo.pid }"  data-options="url:'unitTree.do?notFlag=${vo.flag }',
		                    method:'get',
		                    valueField:'id',
		                    textField:'name',
		                    editable:false
				...
				<tr>
					<th>是否为教育局</th>
					<td >
					   <input name="isEdb"  type="radio"  checked="checked"   value="0">否
					   <input name="isEdb"  type="radio"  <c:if test="${vo.isEdb==1 }">checked="checked"</c:if> value="1">是
					</td>
				</tr>
				<tr>
					<th>单位代码</th>
