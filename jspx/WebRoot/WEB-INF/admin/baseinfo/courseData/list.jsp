...
function  handlerstr(value,row,index){
	  var json = $.toJSON(row);
     var  handstr = "<a href='javascript:void(0)'  iconCls='icon-edit'  onclick='loadF("+json+")';>[修 改]</a> <a href='javascript:void(0)'  iconCls='icon-edit'  onclick='deleteF("+json+")';>[删 除]</a> <a href='javascript:void(0)'  iconCls='icon-edit'  onclick='downloadData("+json+")';>[下 载]</a> ";
     return  handstr;
}
/**
*下载资料
