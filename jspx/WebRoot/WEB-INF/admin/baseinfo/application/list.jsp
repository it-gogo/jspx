...
function  handlerstr(value,row,index){
	  var json = $.toJSON(row);
     var  handstr = "<a href='javascript:void(0)'  iconCls='icon-edit'  onclick='application("+json+")';>[申请学生]</a> " +
     						"<a href='javascript:void(0)'  iconCls='icon-edit'  onclick='lookStudent("+json+")';>[查看学生]</a> " ;
     return  handstr;
}
